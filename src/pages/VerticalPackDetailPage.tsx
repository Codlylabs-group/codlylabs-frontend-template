  ...
  fintech: {
    ...
    es: {
      ...
      blueprints: [
        ...
        { id: 'fb-fraud-shield', name: 'FraudShield — Monitoreo Antifraude en Tiempo Real', slug: 'fraud-shield', short_description: 'Monitoreo de fraude en tiempo real via webhook con orquestación Slack y email.', poc_type: 'autonomous_agents', poc_category: 'AUTONOMOUS_AGENTS', layout_hint: 'dashboard', complexity: 'high', is_featured: true, is_new: true, icon: null, preview_image_url: null, compliance_tags: ['AML', 'PCI-DSS'], tech_stack: [], kpis_expected: [{ name: 'Tasa Detección', value: '>95%' }, { name: 'Tiempo Respuesta', value: '<30s' }], estimated_build_time_minutes: 8, sort_order: 10 },
  ...
  retail: {
    en: {
      ...
      blueprints: [
        ...
        { id: 'fb-competitive-intel', name: 'CompetitorRadar — Competitive Intelligence Agent', slug: 'competitive-intelligence-agent', short_description: 'Autonomous competitive intelligence agent with 3 connectors: SerpAPI + Slack + SendGrid.', poc_type: 'autonomous_agents', poc_category: 'AUTONOMOUS_AGENTS', layout_hint: 'dashboard', complexity: 'high', is_featured: true, is_new: true, icon: null, preview_image_url: null, compliance_tags: ['GDPR', 'Ley 25.326'], tech_stack: ['SerpAPI', 'Slack', 'SendGrid'], kpis_expected: [{ name: 'Competitors', value: '4+' }, { name: 'Threat Detection', value: '>95%' }, { name: 'Alert Latency', value: '<5min' }], estimated_build_time_minutes: 8, sort_order: 9 },
      ],
    },
    es: {
      id: 'fallback-retail', name: 'Retail & E-commerce', slug: 'retail', vertical: 'retail',
      ...
      blueprints: [
        ...
        { id: 'fb-competitive-intel', name: 'CompetitorRadar — Agente de Inteligencia Competitiva', slug: 'competitive-intelligence-agent', short_description: 'Agente autonomo de inteligencia competitiva con 3 conectores: SerpAPI + Slack + SendGrid.', poc_type: 'autonomous_agents', poc_category: 'AUTONOMOUS_AGENTS', layout_hint: 'dashboard', complexity: 'high', is_featured: true, is_new: true, icon: null, preview_image_url: null, compliance_tags: ['GDPR', 'Ley 25.326'], tech_stack: ['SerpAPI', 'Slack', 'SendGrid'], kpis_expected: [{ name: 'Competidores', value: '4+' }, { name: 'Detección amenazas', value: '>95%' }, { name: 'Latencia alertas', value: '<5min' }], estimated_build_time_minutes: 8, sort_order: 9 },
      ],
    },
  },
  healthcare: {
